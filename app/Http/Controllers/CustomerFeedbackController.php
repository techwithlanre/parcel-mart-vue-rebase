...
class CustomerFeedbackController extends Controller
{
    ...
    function showTicket($CustomerFeedback) {
    ...
    function  saveTicketReply(Request $request, $ticket)  {
       ...
       $reply =  CustomerFeedbackReply::create($data);
        ...
        function markReplyAsread($ticketID, $reply_id) {
    ...
    function getTicketmedia($CustomerFeedback)  {
