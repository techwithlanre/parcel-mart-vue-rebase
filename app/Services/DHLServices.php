...
class DHLServices
{
    ...
    private function bookShipmentPayload(Shipment $shipment, ShipmentItem $shipmentItem, InsuranceOption $insuranceOption, ShippingRateLog $shippingRateLog): void
    {
        ...
        $jayParsedAry = [
            ...
            "outputImageProperties" => [
                ...
                "imageOptions" => [
                    [
                        ...
                        "numberOfCopies" => 1.5382681530691,
                        "invoiceType" => "proforma",
                        "languageCode" => "sun",
                        "languageCountryCode" => "in",
                        "encodingFormat" => "png",
                        "renderDHLLogo" => false,
                        "fitLabelsToA4" => true,
                        "labelFreeText" => "cupidatat",
                        "labelCustomerDataText" => "esse laborum incididunt sed"
                    ],
                    [
                        "typeCode" => "receipt",
                        "templateName" => "pariatur",
                        "isRequested" => false,
                        "hideAccountNumber" => false,
                        "numberOfCopies" => 1.8543837325673,
                        "invoiceType" => "proforma",
                        "languageCode" => "eiu",
                        "languageCountryCode" => "ut",
                        "encodingFormat" => "png",
                        "renderDHLLogo" => true,
                        "fitLabelsToA4" => true,
                        "labelFreeText" => "fugiat deserunt commodo dolor",
                        "labelCustomerDataText" => "in nulla incididunt nisi consequat"
                    ]
                ],
            ...
            "onDemandDelivery" => [
                "deliveryOption" => "signatureRelease",
                "location" => "sunt conseq",
                "specialInstructions" => "cupidatat reprehenderit",
                "gateCode" => "eu amet ",
                "whereToLeave" => "neighbour",
                "neighbourName" => "dolore quis labore",
                "neighbourHouseNumber" => "do sed",
                "authorizerName" => "dolore ",
                "servicePointId" => "volu",
                "requestedDeliveryDate" => "tempor dolor"
            ],
        ...
        $this->bookShipmentPayload = [
            'plannedShippingDateAndTime' => '2023-07-03T09:00 GMT+01:00',
            "pickup" => [
                "isRequested" => false,
                "location" => "at reception",
            ],
            'productCode' => $shippingRateLog->product_code,
            'localProductCode' => $shippingRateLog->local_product_code,
            'accounts' => [
                [
                    'typeCode' => 'shipper',
            ...
            'customerReferences' => [
                [
                    'value' => 'dhl'.time().str_shuffle(time()),
                    'typeCode' => 'CU'
                ]
            ],
            /*'identifiers' => [
                [
                    'typeCode' => 'shipmentId',
                    'value' => $shipment->id . '_'.$shippingRateLog->id,
                ]
            ],*/
            'customerDetails' => [
                'shipperDetails' => [
                    'postalAddress' => [
                        ...
                        "provinceCode" => getCountry('id', $destination['country'])->iso2,
                        ...
                        "provinceName" => getState('id', $origin['state'])->name,
                        "countryName" => getCountry('id', $origin['country'])->name
                    ],
                    'contactInformation' => [
                        "email" => $origin['contact_email'] ?? 'muhjamie@gmail.com',
                        "phone" => $origin['contact_phone'],
                        "mobilePhone" => $origin['contact_phone'],
                ...
                'receiverDetails' => [
                    'postalAddress' => [
                        ...
                        "provinceName" => getState('id', $destination['state'])->name,
                        "countryName" => getCountry('id', $destination['country'])->name
                    ],
                    'contactInformation' => [
                        "email" => $destination['contact_email'] ?? 'muhjamie@gmail.com',
                        "phone" => $destination['contact_phone'],
                        "mobilePhone" => $destination['contact_phone'],
                        "companyName" => $destination['company_name'] ?? $origin['contact_name'],
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://express.api.dhl.com/mydhlapi/test/shipments?strictValidation=false&bypassPLTError=false&validateDataOnly=false',
            ...
            CURLOPT_HTTPHEADER => array(
                'Message-Reference: '.time().time().time(),
    ...
    public function hello()
    {
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL => "$this->base_url.'/shipments?strictValidation=false&bypassPLTError=true&validateDataOnly=false'",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
