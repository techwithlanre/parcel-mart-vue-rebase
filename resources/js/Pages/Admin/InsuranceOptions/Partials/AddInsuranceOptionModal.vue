...
const submit = () => {
  form.post(route('insurance.options.store'), {
      ...
      <form @submit.prevent="submit">
        <div class="mt-2 px-6">
          <div>
            ...
            <TextInput v-model="form.name" class="mt-2" required type="text" min="100" placeholder="Enter insurance option name"/>
          </div>
          <div class="mt-3">
            <InputLabel value="Description"/>
            <TextAreaInput v-model="form.description" class="mt-2" required placeholder="Enter insurance option description"/>
          </div>
          <div class="mt-3">
            <InputLabel value="Percentage (%)"/>
            <TextInput v-model="form.percentage" class="mt-2" required type="number" min="1" placeholder="Enter insurance option percentage"/>
          </div>
        </div>
