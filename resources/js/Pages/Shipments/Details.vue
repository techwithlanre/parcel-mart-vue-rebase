                ...
                <div class="shadow border border-gray-50 shadow-background/50 w-full bg-white rounded-xl">
                    <div>
                        <div class="card mt-5">
                            ...
                            <div class="p-4">
                                <div class="font-bold">Total Shipment Amount: {{
                                        Helper.nairaFormat(parseFloat(shipping_rate_log.total_charge) + parseFloat(shipping_rate_log.insurance_amount))
                                    }}
                                </div>
                            </div>
                        </div>
            ...
            <div class="p-5">
                <ol v-if="tracking_log.length > 0" class="relative border-l border-gray-200">
                    <li class="mb-10 ml-4" v-for="item in tracking_log">
                        <div
                            class="absolute w-3 h-3 bg-primary rounded-full mt-1.5 -left-1.5 border border-white sdark:border-gray-900 sdark:bg-gray-700"></div>
                        <time class="mb-1 text-sm font-normal leading-none text-primary sdark:text-gray-500">
                            {{ item.update_datetime }} - <span class="font-semibold">{{
                        ...
                        <p class="mb-4 text-base font-normal text-gray-500 sdark:text-gray-400">Gross Weight:
                            {{ item.gross_weight }}kg</p>
                        <p class="mb-4 text-base font-normal text-gray-500 sdark:text-gray-400">Chargeable Weight:
                            {{ item.gross_weight }}kg</p>
                    </li>
                </ol>
