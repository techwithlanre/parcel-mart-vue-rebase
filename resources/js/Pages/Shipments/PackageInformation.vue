                ...
                <form action="" @submit.prevent="submit">
                    <div class="flex flex-col gap-y-4 p-5">
                        <div class="flex lg:flex-row flex-col w-full gap-x-10 gap-y-4">
                            <div class="w-full">
                                ...
                                <SelectInput v-model="form.category" :options="categories"
                                             place-holder="" :class="{'border-orange-300': form.errors.category}"
                                             class="mt-2 w-full"/>
                            ...
                            <div class="w-full">
                                ...
                                <TextInput type="text" v-model="form.value" min="0"
                                           placeholder="" :class="{'border-orange-300': form.errors.value}"
                                           class="mt-2"/>
                        ...
                        <div>
                            ...
                            <TextAreaInput v-model="form.description" rows="7"
                                           :class="{'border-orange-300': form.errors.description}" class="mt-2"
                        ...
                        <div class="flex lg:flex-row flex-col items-center w-full gap-x-10 gap-y-4 mt-10">
                            ...
                            <PrimaryButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Next
                            </PrimaryButton>
                        </div>
                    </div>
                </form>
